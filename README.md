...
_💡 Выйти из редактора Vim: нажать Esc, ввести :qa!, нажать Enter._
...
Схема статусов в виде mermaid-схемы:
...
* [Conventional Commits](https://www.conventionalcommits.org/) предлагает стандартизированный формат коммита с указанием типа изменений.
